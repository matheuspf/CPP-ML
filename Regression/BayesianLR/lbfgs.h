...
#include "../../LineSearch/FiniteDifference.h"
...
void lbfgs (Function func, Eigen::VectorXd& theta, int m = 20, double error = 1e-8, int iterations = 100)
{
	lbfgs(func, opt::gradientFD(func), theta, m, error, iterations);
}
